...
<div class="row">
  <div class="col-lg-3 p-3">
    ...
    <div class="">
      <div class="list-group">
        <a href="{{url('/storeemulsionemulsion_ext')}}" class="list-group-item main_bg_color text-white">Emulsion-exterior</a>
        <a href="{{url('/storeemulsionemulsion_int')}}" class="list-group-item text-dark bg-light">Emulsion-interior</a>
      </div>
    </div>
  ...
  <div class="col-lg-9 card p-3 main_bg_color">
    ...
    @endif
    <div class="row">
      @if($items = App\EmulsionExterior::all())
