...
<div class="container-fluid pt-5">
      ...
      <ol class="breadcrumb mt-4">
        ...
        <li class="breadcrumb-item active">Texcote interior</li>
      </ol>
<div class="row">
  <div class="col-lg-3 p-3">
    ...
    <div class="">
      <div class="list-group">
        <a href="{{url('/storetexcotetexcote_ext')}}" class="list-group-item text-dark bg-light">Texcote-exterior</a>
        <a href="{{url('/storetexcotetexcote_int')}}" class="list-group-item main_bg_color text-white">Texcote-interior</a>
      </div>
    </div>
  ...
  <div class="col-lg-9 card p-3 main_bg_color">
    ...
    @endif
    <div class="row">
      @if($items = App\TexcoteInterior::all())
